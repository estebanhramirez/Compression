...
def find_patterns_wrapper(sentences, unique_words, k, previous_n_gram, prev_prob):
    ...
    for nxt in probability_matrix.columns:
        ...
        if np.log(1/prob)/prob < threshold:
            ...
            find_patterns_wrapper(sentences, unique_words, k, previous_n_gram+[nxt], prev_prob*prob)
...
def find_patterns(sentences, unique_words, k, previous_n_gram):
    ...
    probability_matrix = make_probability_matrix(n_plus1_gram_counts, unique_words, k)
    for nxt in probability_matrix.columns:
        find_patterns_wrapper(sentences, unique_words, k, previous_n_gram+[nxt], probability_matrix.loc[[tuple(previous_n_gram)]][nxt][0])
        print('----------------------------------------------------------------------')
...
def main():
    ...
    #txt = ['a', 'a', 'b', 'b', 'a', 'a', 'b', 'b', 'a', 'a', 'b', 'b', 'a', 'a', 'b', 'b', 'a', 'a', 'b', 'b', 'a', 'a']
    #txt = ['a', 'a', 'a', 'a', 'c', 'a', 'a', 'c', 'b', 'b', 'c', 'a', 'a', 'c', 'b', 'b', 'c', 'd', 'd', 'e', 'e', 'd', 'd', 'e', 'e']
    #txt = ['a', 'b', 'a', 'b', 'a', 'b', 'c', 'c', 'c', 'c', 'd', 'e', 'd', 'e', 'd', 'e', 'f'] # threshold = 0.70 & threshold = abs(average-entropy)
    #txt = ['a', 'b', 'c', 'd']*2  # threshold = 0.95
    txt = ['a', 'b']*3
    #txt = ['c', 'c', 'c', 'k', 'a', 'a', 'z', 'l', 'm', 'a', 'a', 'n', 'a', 'a', 'o', 'w', 'a', 'a', 'x', 'v', 'a', 'a', 'y', 'a', 'a', 't', 'g', 'h', 'b', 'b', 'b', 'h', 'a', 'a']
    #txt = ['c', 'c', 'c', 'z', 'a', 'a', 'w', 'z', 'z', 'a', 'a', 'w', 'a', 'a', 'w', 'z', 'a', 'a', 'w', 'z', 'a', 'a', 'z', 'a', 'a', 'z', 'z', 'z', 'b', 'b', 'b', 'z', 'a', 'a']
