...
def viterbi_forward(A, B, test_corpus, best_probs, best_paths, vocab, verbose=True):
    ...
    for i in range(1, len(test_corpus)): 
        ...
        for j in range(0, num_tags): # Replace None in this line with the proper range. # for every pos tag
            ...
            for k in range(0, num_tags): # Replace None in this line with the proper range.
